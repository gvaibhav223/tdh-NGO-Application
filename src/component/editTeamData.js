...
export default function CreateNFT(userProfileData) {
  ...
  const mediaData = location.state
  const idduserdata=mediaData?._id;
  // console.log("asdasdadad",mediaid)
  console.log("zxczxczxcxzczx", mediaData?._id)
  const imagesec = mediaData?.picture;
  ...
  console.log("ajsfhalksdf",imagesec);
  ...
  const editMedia = async ({values,idduserdata}) => {
    {console.log("lkasdjflkasdf",idduserdata)}
    try {
  ...
  return (
    <Box className={classes.NftBreed}>
      <Box className={classes.devicelistHeading}>
        ...
        {window.location.pathname === "/edit-media" && (
      ...
      <Container maxWidth="md">
        <Formik
          ...
          onSubmit={(values) => editMedia({values,idduserdata})}
        >
          {({
            errors,
            handleBlur,
                          ...
                          >
                            ...
                            <Box style={{ marginTop: "16px" }}>
                              ...
                              <Button
                                variant="contained"
                                type="submit"
                                // onClick={() => history.push("/edit-partner")}
                                color="primary"
                              >
                                Update
                              </Button>
