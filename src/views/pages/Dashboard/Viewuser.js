          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} sm={12} md={8} lg={8}>
              <Grid container spacing={1}>
                ...
                <Grid item lg={9} md={6} sm={7} xs={12}>
                  <Typography variant="h6">Sonu Kumar</Typography>
                </Grid>
                <Grid item lg={3} md={4} sm={5} xs={12}>
                ...
                <Grid item lg={9} md={6} sm={7} xs={12}>
                  <Typography variant="h6">New Delhi</Typography>
                </Grid>
            ...
            <Grid item lg={12} md={12} sm={12} xs={12}>
              <Box>
                <Typography variant="h6">
                  According to all the information provided by you, it seems to
                  us that you are having trouble at sleeping in night, which
                  makes it hard for you to get up early in the morning to
                  continue your daily routine.It also shows that your menstrual
                  cycle was 30 days which is within the normal medical range i:e
                  21- 35 days.
                </Typography>
              </Box>
            </Grid>
